    ...
    >
      ...
      <header className="container mx-auto p-4 flex items-center justify-between sticky top-0 z-50 bg-[#1E0B32]/80 backdrop-blur-sm">
        ...
        <Button
          ...
          onClick={() =>
            window.open(
              "https://wa.me/386000000000?text=Hello%2C%20I%20would%20like%20to%20learn%20more%20about%20the%20Cortex%20Back-End%20Development%20program.",
              "_blank",
            )
          }
        >
      ...
      <div className="container mx-auto px-4 py-16 md:py-24 text-center max-w-4xl">
        ...
        <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
          Launch Your Career in Back-End Development
        </h1>
        <p className="text-lg mb-10 text-gray-300 leading-relaxed">
          Master server-side development in just 3 months. Get hands-on training, build real APIs and databases, and
        ...
        <Button
          ...
          onClick={() =>
            window.open(
              "https://wa.me/386000000000?text=Hello%2C%20I%20would%20like%20to%20register%20for%20the%20Cortex%20Back-End%20Development%20program.%20I%20have%20received%20the%20information%20and%20would%20like%20to%20proceed%20with%20the%20registration.%20Please%20guide%20me%20through%20the%20next%20steps.",
              "_blank",
            )
          }
        >
          ...
          {[
            {
              ...
              description:
                "Build 5+ production-ready APIs and backend systems. Stand out to employers with a professional portfolio of server applications.",
            },
            {
              icon: Trophy,
              title: "1-on-1 Career Coaching",
              description:
                "Personal guidance from industry experts to fast-track your career growth and land your dream backend developer job.",
            },
            {
              icon: Award,
              title: "ICT Cortex Certification",
              description:
                "Earn a recognized qualification that validates your backend development skills and opens doors to top tech opportunities.",
            },
          ].map((benefit, index) => (
            <div
              key={index}
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between max-w-5xl mx-auto">
            <div className="text-black mb-8 md:mb-0">
              <h2 className="text-3xl font-bold mb-4">Ready to Build Powerful Backend Systems?</h2>
              <p className="mb-8">
              ...
              <Button
                ...
                onClick={() =>
                  window.open(
                    "https://wa.me/386000000000?text=Hello%2C%20I%20would%20like%20to%20schedule%20a%20free%20consultation%20for%20the%20Cortex%20Back-End%20Development%20program.",
                    "_blank",
                  )
                }
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                {["Back-End Development", "DevOps"].map((item, index) => (
                  <li key={index}>
                    <Link
                      href="#"

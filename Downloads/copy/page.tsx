  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 py-16 md:py-24 text-center max-w-4xl">
        ...
        <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Launch Your Career in Copywriting</h1>
        <p className="text-lg mb-10 text-gray-300 leading-relaxed">
          Master the art of persuasive writing in just 3 months. Get hands-on training, build a powerful portfolio, and
          kickstart your career in copywriting.{" "}
        ...
        <Button
          ...
          onClick={() =>
            window.open(
              "https://wa.me/386000000000?text=Hello%2C%20I%20would%20like%20to%20register%20for%20the%20Cortex%20Copywriting%20program.%20I%20have%20received%20the%20information%20and%20would%20like%20to%20proceed%20with%20the%20registration.%20Please%20guide%20me%20through%20the%20next%20steps.",
              "_blank",
            )
          }
        >
      ...
      <div className="bg-[#2A1245] py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              { value: "400+", label: "Copywriters trained" },
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between max-w-5xl mx-auto">
            <div className="text-black mb-8 md:mb-0">
              <h2 className="text-3xl font-bold mb-4">Ready to Master the Art of Copywriting?</h2>
              <p className="mb-8">
              ...
              <Button
                ...
                onClick={() =>
                  window.open(
                    "https://wa.me/386000000000?text=Hello%2C%20I%20would%20like%20to%20schedule%20a%20free%20consultation%20for%20the%20Cortex%20Copywriting%20program.",
                    "_blank",
                  )
                }
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                {["Copywriting", "Content Marketing"].map((item, index) => (
                  <li key={index}>
                    <Link
                      href="#"

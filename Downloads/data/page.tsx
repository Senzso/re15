    ...
    >
      ...
      <header className="container mx-auto p-4 flex items-center justify-between sticky top-0 z-50 bg-[#1E0B32]/80 backdrop-blur-sm">
        ...
        <Button
          ...
          onClick={() =>
            window.open(
              "https://wa.me/386000000000?text=Hello%2C%20I%20would%20like%20to%20learn%20more%20about%20the%20Cortex%20Data%20Scientist%20program.",
              "_blank",
            )
          }
        >
      ...
      <div className="container mx-auto px-4 py-16 md:py-24 text-center max-w-4xl">
        ...
        <Button
          ...
          onClick={() =>
            window.open(
              "https://wa.me/386000000000?text=Hello%2C%20I%20would%20like%20to%20register%20for%20the%20Cortex%20Data%20Scientist%20program.%20I%20have%20received%20the%20information%20and%20would%20like%20to%20proceed%20with%20the%20registration.%20Please%20guide%20me%20through%20the%20next%20steps.",
              "_blank",
            )
          }
        >
          ...
          <div className="flex flex-col md:flex-row items-center justify-between max-w-5xl mx-auto">
            <div className="text-black mb-8 md:mb-0">
              ...
              <Button
                ...
                onClick={() =>
                  window.open(
                    "https://wa.me/386000000000?text=Hello%2C%20I%20would%20like%20to%20schedule%20a%20free%20consultation%20for%20the%20Cortex%20Data%20Scientist%20program.",
                    "_blank",
                  )
                }
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                {["Data Science", "Machine Learning"].map((item, index) => (
                  <li key={index}>
                    <Link
                      href="#"

    ...
    >
      ...
      <div className="container mx-auto px-4 py-16 md:py-24 text-center max-w-4xl">
        ...
        <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
          Launch Your Career in Social Media Marketing
        </h1>
        <p className="text-lg mb-10 text-gray-300 leading-relaxed">
          Master the art of social media strategy and content creation in just 3 months. Get hands-on training, build a
          powerful portfolio, and kickstart your career in social media marketing.{" "}
        ...
        >
          START YOUR JOURNEY AS A MARKETER
        </Button>
      ...
      <div className="bg-[#2A1245] py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              { value: "400+", label: "Social media marketers trained" },
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between max-w-5xl mx-auto">
            <div className="text-black mb-8 md:mb-0">
              <h2 className="text-3xl font-bold mb-4">Ready to Master Social Media Marketing?</h2>
              <p className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                {["Data Science", "Social Media Marketing"].map((item, index) => (
                  <li key={index}>
                    <Link
                      href="#"
